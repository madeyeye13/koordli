<div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
    ...
    <div style="display: flex; align-items: center; gap: 12px;">
        ...
        >
            <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- Notifications bell --}}
        <button style="background: none; border: none; cursor: pointer; color: #78716C; display: flex; align-items: center; padding: 6px; position: relative;">
