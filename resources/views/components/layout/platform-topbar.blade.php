<div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
    ...
    {{-- Right --}}
    <div style="display: flex; align-items: center; gap: 12px;">
        <div class="platform-status-desktop">
            <livewire:platform.support.agent-status />
        </div>
        <livewire:platform.notifications.platform-notification-center />
        {{-- Dark mode toggle --}}
        <button
        ...
        >
            <svg x-show="!$store.theme.dark" x-cloak xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- Platform badge --}}
        <span
            class="krd-badge krd-badge-violet platform-admin-badge"
