    ...
    <nav style="flex: 1; padding: 8px 0; overflow-y: auto;"
        ...
        <div class="krd-nav-section">
            ...
            <a href="{{ route('vendor.availability') }}"
               class="krd-nav-item {{ request()->routeIs('vendor.availability') ? 'active' : '' }}"
               wire:navigate>
                <svg class="krd-nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('vendor.conversations') }}"
               class="krd-nav-item {{ request()->routeIs('vendor.conversations*') ? 'active' : '' }}"
               wire:navigate
               style="display:flex;align-items:center;">
                ...
                Messages
                <livewire:vendor.conversations.unread-badge lazy />
            </a>
        </div>

        <div class="krd-nav-section">
            <div class="krd-nav-label">Settings</div>
            <a href="{{ route('vendor.notifications.preferences') }}"
               class="krd-nav-item {{ request()->routeIs('vendor.notifications.preferences') ? 'active' : '' }}"
               wire:navigate>
                <svg class="krd-nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
