    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        ...
        <div class="krd-card">
            ...
            <div class="krd-input-group" style="margin-bottom:0;">
                ...
                <input type="text" value="{{ auth('client')->user()->email }}" disabled class="krd-input" style="background:#F5F5F4;color:#A8A29E;" />
                <span class="krd-input-hint">Contact your event organizer to change your email.</span>
            </div>
