<div>
    <div style="margin-bottom:24px;">
        ...
        <p style="font-size:13px;color:#78716C;margin-top:4px;">Conversations with your event team.</p>
    </div>
    ...
    <div class="krd-card">
        <div class="krd-empty-state">
            ...
            <div class="krd-empty-state-desc">Your event coordinator will start a conversation with you here.</div>
        </div>
    </div>
    @else
    <div style="display:flex;flex-direction:column;gap:2px;">
        @foreach($conversations as $conv)
        <a href="{{ route('client.conversations.show', $conv->uuid) }}" wire:navigate class="krd-card" style="display:flex;align-items:center;justify-content:space-between;gap:12px;text-decoration:none;margin-bottom:10px;">
