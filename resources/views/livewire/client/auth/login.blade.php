    ...
    <div class="krd-auth-panel">
        ...
        <div style="max-width: 360px;">
            <h1 style="font-size: 40px; font-weight: 700; color: #FAFAF9; line-height: 1.1; letter-spacing: -0.02em; margin-bottom: 16px;">
                Your event,<br>
                <span style="color: #F59E0B;">at a glance.</span>
            </h1>
            <p style="font-size: 14px; color: #78716C; line-height: 1.8; margin-bottom: 40px;">
                Log in to view your event details, timeline, and updates — all in one place.
            </p>

            <div style="display: flex; flex-direction: column; gap: 12px;">
                @foreach([
                    ['icon' => '📅', 'text' => 'Event date, venue & timeline'],
                    ['icon' => '💰', 'text' => 'Budget & payment tracking'],
                    ['icon' => '📋', 'text' => 'Notes from your coordinator'],
                    ['icon' => '👥', 'text' => 'Guest count & expectations'],
                ] as $feature)
