<div style="position:relative;">
    <button wire:click="togglePanel"
        ...
        x-data
        x-on:platform-notification-received.window="$wire.$refresh()">
...
document.addEventListener('alpine:init', () => {
    window.Echo.private('notifications.platform-user.{{ auth("platform")->id() }}')
        .notification(() => {
            window.dispatchEvent(new CustomEvent('platform-notification-received'));
        });
});
</script>