<div style="max-width: 480px; margin: 0 auto; padding: 48px 0;">
    ...
    <div style="text-align:center;margin-bottom:40px;">
        ...
        <p style="font-size:13px;color:#78716C;line-height:1.7;">
            For your security, please set a new password before accessing your vendor portal.
        </p>
    </div>
    ...
    <div class="krd-card" style="padding:28px;">
        ...
        <div style="margin-top:20px;">
            <button wire:click="save" wire:loading.attr="disabled"
                ...
                <span wire:loading.remove wire:target="save">Set Password & Enter Portal</span>
