<div>
    <div style="margin-bottom:20px;">
        <a href="{{ route('vendor.conversations') }}" wire:navigate style="color:#A8A29E;text-decoration:none;font-size:13px;">← Back to Messages</a>
    ...
    <div class="krd-card" id="conv-scroll" style="padding:24px;margin-bottom:16px;max-height:500px;overflow-y:auto;"
        wire:ignore
        x-data="vendorConversationWidget(@js($conversation->uuid))"
    >
        @foreach($conversation->messages as $msg)
        @php $isMe = $msg->sender_type === 'vendor_account' && $msg->sender_id === auth('vendor')->id(); @endphp
