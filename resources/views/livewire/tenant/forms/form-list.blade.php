<div x-data="{ showDeleteModal: false, deleteId: null }">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:6px;flex-wrap:wrap;">
                                ...
                                <button x-on:click="showDeleteModal = true; deleteId = {{ $form->id }}" class="krd-btn krd-btn-sm" style="background:#FEE2E2;color:#DC2626;border-color:#FECACA;">
    ...
    <div id="forms-mobile" style="display:flex;flex-direction:column;gap:10px;">
        ...
        <div class="krd-card" style="padding:16px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                ...
                <button x-on:click="showDeleteModal = true; deleteId = {{ $form->id }}" class="krd-btn krd-btn-sm" style="background:#FEE2E2;color:#DC2626;border-color:#FECACA;">Delete</button>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div x-show="showDeleteModal" x-cloak style="position:fixed;left:0;top:0;width:100vw;height:100vh;background:rgba(0,0,0,0.4);z-index:60;">
        <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);background:#fff;border-radius:8px;padding:28px;max-width:400px;width:90%;box-shadow:0 20px 50px rgba(28,25,23,0.2);">
            <h3 style="font-size:16px;font-weight:600;color:#1C1917;margin-bottom:8px;">Delete Form?</h3>
            <p style="font-size:13px;color:#78716C;margin-bottom:24px;line-height:1.6;">
                This will permanently delete this form and all its submissions. This cannot be undone.
            </p>
            <div style="display:flex;gap:10px;">
                <button x-on:click="showDeleteModal = false; deleteId = null; $wire.deleteForm(deleteId)" class="krd-btn krd-btn-danger" style="flex:1;">Yes, Delete</button>
