    ...
    <div class="krd-auth-panel">
        ...
        <div style="max-width: 360px;">
            <h1 style="font-size: 40px; font-weight: 700; color: #FAFAF9; line-height: 1.1; letter-spacing: -0.02em; margin-bottom: 16px;">
                Run your events.<br>
                Not your <span style="color: #F59E0B;">inbox.</span>
            </h1>
            <p style="font-size: 14px; color: #78716C; line-height: 1.8; margin-bottom: 40px;">
                Manage events, clients, vendors, budgets, and guest experiences — all in one place.
            </p>

            <div style="display: flex; flex-direction: column; gap: 12px;">
                @foreach([
                    ['icon' => '⚡', 'text' => 'Event operations & runsheets'],
                    ['icon' => '👥', 'text' => 'Client & guest experience'],
                    ['icon' => '📋', 'text' => 'Vendor coordination'],
                    ['icon' => '💳', 'text' => 'Budget & payment tracking'],
                ] as $feature)
        ...
        <div style="width: 100%; max-width: 380px; padding: 32px 0;">
            ...
            <div style="margin-bottom: 32px;">
                ...
                <p style="font-size: 13px; color: #78716C;">
                    Sign in to your planning portal.
                </p>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px; margin-top: 4px;">
                ...
                />
                <label for="remember" style="font-size: 13px; color: #57534E; cursor: pointer;">
            ...
            <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #E7E5E4; text-align: center;">
                <p style="font-size: 12px; color: #A8A29E;">
                    ...
                    <a href="{{ route('register') }}" wire:navigate style="color: #7C3AED; text-decoration: none; font-weight: 500;">Create one free</a>
                </p>
            </div>
