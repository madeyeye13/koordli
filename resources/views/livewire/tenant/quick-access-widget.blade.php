...
@if($enabled)
    ...
    {{-- Educational tip — appears automatically on load, independent of
         the dropdown below, so it teaches what this icon does BEFORE
         someone clicks it, not after. --}}
    <div x-show="!tipDismissed" x-cloak
        ...
        <div style="display:flex;justify-content:space-between;gap:8px;">
            ...
            <button x-on:click="tipDismissed = true; localStorage.setItem('krd-tip-dismissed-quick-access-icon-tenant', '1')"
    ...
    <div x-show="show" x-cloak x-on:click.outside="show = false" style="position:absolute;top:36px;right:0;width:300px;background:#fff;border:1px solid #E7E5E4;border-radius:10px;box-shadow:0 12px 32px rgba(0,0,0,0.15);z-index:60;padding:16px;">
        ...
        <div style="display:flex;gap:6px;">
            ...
            <x-ui.confirm-button action="regenerate" message="This invalidates your current link. Continue?" label="Regenerate" class="krd-btn krd-btn-ghost krd-btn-sm" style="flex:1;" />
        </div>
