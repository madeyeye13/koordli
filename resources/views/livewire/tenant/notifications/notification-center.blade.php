<div style="position:relative;">
    ...
    @if($showPanel)
    <div style="position:fixed;inset:0;z-index:59;" wire:click="togglePanel"></div>
    <div style="position:absolute;top:36px;right:0;width:360px;max-height:480px;background:#fff;border:1px solid #E7E5E4;border-radius:10px;box-shadow:0 12px 32px rgba(0,0,0,0.15);z-index:60;overflow:hidden;display:flex;flex-direction:column;">
        ...
        <div style="padding:10px 16px;border-top:1px solid #E7E5E4;text-align:center;">
            <a href="{{ route('tenant.notifications.preferences') }}" wire:navigate style="font-size:11px;color:#7C3AED;text-decoration:none;">Notification Settings</a>
        </div>
    </div>
    @endif
</div>
...
document.addEventListener('alpine:init', () => {
    window.Echo.private('notifications.tenant-user.{{ auth()->id() }}')
        .notification(() => {
