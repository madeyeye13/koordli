<div x-data="{ showDeleteModal: false, deleteId: null }">
    ...
    <div class="krd-grid-3" style="gap:16px;">
        ...
        <div class="krd-card" style="padding:20px;">
            ...
            <div style="display:flex;gap:8px;">
                ...
                <button x-on:click="showDeleteModal = true; deleteId = {{ $template->id }}" class="krd-btn krd-btn-sm" style="background:#FEE2E2;color:#DC2626;border-color:#FECACA;">
    ...
    <div x-show="showDeleteModal" x-cloak style="position:fixed;left:0;top:0;width:100vw;height:100vh;background:rgba(0,0,0,0.4);z-index:60;">
        <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);background:#fff;border-radius:8px;padding:28px;max-width:400px;width:90%;box-shadow:0 20px 50px rgba(28,25,23,0.2);">
            ...
            <p style="font-size:13px;color:#78716C;margin-bottom:24px;line-height:1.6;">Existing contracts created from this template will not be affected. This cannot be undone.</p>
            <div style="display:flex;gap:10px;">
