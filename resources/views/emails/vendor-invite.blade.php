        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="note">
                    ...
                    Never share your password with anyone. If you have questions, contact
                    <strong style="color:#78716C;">{{ $companyName }}</strong> directly.<br><br>
                    If this invitation was sent in error, you can safely ignore this email.
                </div>
            </div>
            <div class="footer">
