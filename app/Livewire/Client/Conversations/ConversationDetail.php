...
class ConversationDetail extends Component
{
    ...
    public function mount(string $uuid): void
    {
        ...
        abort_unless($this->conversation->hasParticipant('client', auth('client')->id()), 403);
    ...
    public function markRead(): void
    {
        ConversationParticipant::where('conversation_id', $this->conversation->id)
            ...
            ->where('participant_id', auth('client')->id())
    ...
    {
        return view('livewire.client.conversations.conversation-detail');
    }
}